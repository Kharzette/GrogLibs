...
partial class MaterialForm
{
	...
	private void InitializeComponent()
	{
			...
			this.MeshMatGroupBox = new System.Windows.Forms.GroupBox();
			...
			this.MeshMatGroupBox.SuspendLayout();
			...
			this.MaterialList.Size = new System.Drawing.Size(483, 183);
			...
			this.FileGroup.Location = new System.Drawing.Point(505, 480);
			...
			// MeshMatGroupBox
			// 
			this.MeshMatGroupBox.Controls.Add(this.label9);
			this.MeshMatGroupBox.Controls.Add(this.label8);
			this.MeshMatGroupBox.Controls.Add(this.label7);
			this.MeshMatGroupBox.Controls.Add(this.LightColor2);
			this.MeshMatGroupBox.Controls.Add(this.LightColor1);
			this.MeshMatGroupBox.Controls.Add(this.LightColor0);
			this.MeshMatGroupBox.Controls.Add(this.SpecPower);
			this.MeshMatGroupBox.Controls.Add(this.label4);
			this.MeshMatGroupBox.Controls.Add(this.label3);
			this.MeshMatGroupBox.Controls.Add(this.SpecColor);
			this.MeshMatGroupBox.Controls.Add(this.label2);
			this.MeshMatGroupBox.Controls.Add(this.SolidColor);
			this.MeshMatGroupBox.Location = new System.Drawing.Point(13, 12);
			this.MeshMatGroupBox.Margin = new System.Windows.Forms.Padding(4, 3, 4, 3);
			this.MeshMatGroupBox.Name = "MeshMatGroupBox";
			this.MeshMatGroupBox.Padding = new System.Windows.Forms.Padding(4, 3, 4, 3);
			this.MeshMatGroupBox.Size = new System.Drawing.Size(188, 253);
			this.MeshMatGroupBox.TabIndex = 19;
			this.MeshMatGroupBox.TabStop = false;
			this.MeshMatGroupBox.Text = "Mesh Shader Shtuff";
			// 
			// label9
			// 
			...
			// Texture1Pic
			// 
			this.Texture1Pic.Location = new System.Drawing.Point(63, 128);
			...
			// Texture0Pic
			// 
			this.Texture0Pic.Location = new System.Drawing.Point(63, 22);
			...
			// GuessTextures
			// 
			this.GuessTextures.Location = new System.Drawing.Point(396, 12);
        ...
        "ally doesn\'t work very well.");
			...
			this.MeshPartList.Size = new System.Drawing.Size(582, 134);
			...
			// TextureGroupBox
			// 
			this.TextureGroupBox.Controls.Add(this.Texture0Pic);
			this.TextureGroupBox.Controls.Add(this.Texture1Pic);
			this.TextureGroupBox.Controls.Add(this.label5);
			this.TextureGroupBox.Controls.Add(this.label6);
			this.TextureGroupBox.Location = new System.Drawing.Point(208, 12);
			this.TextureGroupBox.Name = "TextureGroupBox";
			this.TextureGroupBox.Size = new System.Drawing.Size(181, 253);
			this.TextureGroupBox.TabIndex = 24;
			this.TextureGroupBox.TabStop = false;
			this.TextureGroupBox.Text = "Texture Shtuff";
			// 
			// MaterialForm
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(608, 675);
			...
			this.Controls.Add(this.MeshMatGroupBox);
			...
			this.MeshMatGroupBox.ResumeLayout(false);
			this.MeshMatGroupBox.PerformLayout();
	...
	private System.Windows.Forms.GroupBox MeshMatGroupBox;
    ...
    private GroupBox TextureGroupBox;
}