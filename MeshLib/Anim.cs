...
public class Anim
{
	...
	public void TransformBoneAnim(string bone, Matrix4x4 trans)
	{
		bool	bFound	=false;
	...
	public void FixDetatchedSkeleton(Skeleton skel, string brokenNode)
	{
		...
		foreach(float time in times)
		{
			...
			Matrix4x4	brokenMat	=Matrix4x4.CreateScale(brokenKeys[keyIndex].mScale) *
				Matrix4x4.CreateFromQuaternion(brokenKeys[keyIndex].mRotation) *
				Matrix4x4.CreateTranslation(brokenKeys[keyIndex].mPosition);
...
//				brokenMat	=Matrix.Invert(brokenMat);
			...
			Matrix4x4.Decompose(brokenMat, out brokenKeys[keyIndex].mScale,
